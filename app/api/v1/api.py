...
from app.api.v1.endpoints import montgomery_foreclosure_cases, montgomery_probate_cases, montgomery_divorce_cases, scraping_logs
...
api_router.include_router(scraping_logs.router, prefix="/scraping-logs", tags=["scraping-logs"]) 